...
type Store interface {
	...
	CreateBuildArtifact(ctx context.Context, build AppBuildJob, artifact AppBuildArtifact, cfg Config) (AppBuildJob, AppBuildArtifact, error)
	...
	GetBuildArtifactStorageKey(ctx context.Context, artifactID string) (string, string, error)
